...
fuel._validateOptions = function (options, callback) {
	...
	} else if( !options.clientId || 'undefined' == options.clientId || null == options.clientId ) {
		message = 'clientId is required';
	} else if( !options.clientSecret || 'undefined' == options.clientSecret || null == options.clientSecret ) {
