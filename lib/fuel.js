...
fuel._validateOptions = function (options, callback) {
	...
	} else if( !options.authUrl || 'undefined' == options.authUrl || null == options.authUrl ) {
		message = 'authUrl is required';
	} else if( !options.clientId || 'undefined' == options.clientId || null == options.clientId || !fuel._verifyAPIKey( 'clientId', options.clientId, callback ) ) {
		message = 'clientId is required';
	} else if( !options.clientSecret || 'undefined' == options.clientSecret || null == options.clientSecret || !fuel._verifyAPIKey( 'clientSecret', options.clientSecret, callback )) {
		message = 'clientSecret is require';
	}
